...
lines = [
    ...
    "-- Auto-generated by scripts/generate_schema_sql.py",
...
for ds, (table, col_defs) in table_col_defs.items():
    ...
    lines2 = [
        ...
        f"# Source: scripts/generate_schema_sql.py  →  standardized_columns.csv",
        f"# Format: {{original_col_name: (pg_col_name, coerce_func_name)}}",
        f"# DO NOT EDIT by hand; re-run scripts/generate_schema_sql.py instead.",
        f"COLUMN_MAP = {{",
    ]
