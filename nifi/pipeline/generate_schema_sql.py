...
lines = [
    ...
    "-- Auto-generated by nifi/pipeline/generate_schema_sql.py",
...
for ds, (table, col_defs) in table_col_defs.items():
    ...
    lines2 = [
        ...
        f"# Source: nifi/pipeline/generate_schema_sql.py  \u2192  standardized_columns.csv",
        f"# Format: {{original_col_name: (pg_col_name, coerce_func_name)}}",
        f"# DO NOT EDIT by hand; re-run nifi/pipeline/generate_schema_sql.py instead.",
        f"COLUMN_MAP = {{",
    ]
