        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-xs text-muted-foreground">
              Datasets triggered per run: <span className="font-medium">ehvol, bhs</span>
            </div>
            ...
            {jobs.length === 0 ? (
              ...
              jobs.map((job) => (
                <div key={job.jobId} className="border rounded-md p-3 space-y-2">
                  ...
                  <div className="text-xs text-muted-foreground">
                    schema={job.request?.schema || 'public'} datasets={(job.request as any)?.datasets?.join(', ') || 'ehvol, bhs'}
                  </div>
