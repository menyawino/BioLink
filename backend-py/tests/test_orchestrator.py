...
class OrchestratorTests(unittest.IsolatedAsyncioTestCase):
    async def test_routes_to_sql_agent(self):
        ...
        orchestrator = ChatOrchestrator(tool_registry=registry, router=IntentRouter())
    ...
    async def test_routes_to_cohort_agent(self):
        ...
        self.assertEqual(result.agent, "cohort")
    ...
    async def test_routes_to_ui_agent(self):
        ...
        self.assertEqual(result.agent, "ui")
    ...
    async def test_routes_to_rag_agent(self):
        ...
        self.assertEqual(result.content, "rag ok")
